...
import com.daemonz.animange.ad.OnShowAdCompleteListener
...
@HiltAndroidApp
class AnimanApp : MultiDexApplication(), Application.ActivityLifecycleCallbacks,
    ...
    private inner class AppOpenAdManager {
        ...
        fun loadAd(context: Context) {
            ...
            isLoadingAd = true
            val adId =
                if (BuildConfig.BUILD_TYPE == "release") AdmobConst.OPEN_ADAPTIVE else AdmobConstTest.OPEN_ADAPTIVE
...
//                        Toast.makeText(activity, "onAdShowedFullScreenContent", Toast.LENGTH_SHORT).show()
    ...
    companion object {
        private const val LOG_TAG = "AM#AnimanApp"
    }
