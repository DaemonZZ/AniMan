...
@AndroidEntryPoint
class HomeMangaFragment :
    BaseFragment<FragmentHomeBinding, HomeMangaViewModel>(FragmentHomeBinding::inflate),
    AdBannerHandler {
    override val viewModel: HomeMangaViewModel by activityViewModels()
