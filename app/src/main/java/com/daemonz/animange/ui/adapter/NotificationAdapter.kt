...
) : BaseRecyclerAdapter<Notification, MenuItemCommonBinding>(onItemClickListener) {
    override val bindingInflater: (LayoutInflater, ViewGroup?, Boolean) -> MenuItemCommonBinding
        get() = MenuItemCommonBinding::inflate

    @OptIn(ExperimentalBadgeUtils::class)
    override fun bindView(binding: MenuItemCommonBinding, item: Notification, position: Int) {
        binding.apply {
